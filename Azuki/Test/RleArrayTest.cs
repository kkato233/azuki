...
namespace Sgry.Azuki.Test
{
	static class RleArrayTest
	{
		...
		static void Test_InitDispose()
		{
			...
			chars = new RleArray<char>( new char[]{'a', 'b', 'c'} );
		...
		static void Test_GetSet()
		{
			...
			{
				// set - same value
				chars = new RleArray<char>( "aabbbcc" );
				chars[2] = 'b';
		...
		static void Test_IndexOf()
		{
			...
			chars = new RleArray<char>( "aabbcca" );
